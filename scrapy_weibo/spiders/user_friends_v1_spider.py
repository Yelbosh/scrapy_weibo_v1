...
FRIENDS_UID_URL = 'http://api.t.sina.com.cn/friends/ids.json?user_id={uid}&source=' + API_KEY + '&count=' + str(count_per_page)


class UserFriendsSpiderV1(BaseSpider):
    """usage: scrapy crawl user_friends_v1 -a from_text=1 -a since_id=1 -a max_id=100"""
    name = "user_friends_v1"

    def __init__(self, **kw):
        super(UserFriendsSpiderV1, self).__init__(**kw)
